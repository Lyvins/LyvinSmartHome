...
namespace LyvinDeviceAPIContracts.DeviceAPIMessages
{
    ...
    public class DeviceChangedEvent
    {
        ...
        [DataMember]
        public DeviceChangedEventBody Body { get; set; }
        ...
        {
            Body = new DeviceChangedEventBody();
            Header = new DeviceAPIHeader();
        }

        public DeviceChangedEvent(DeviceChangedEventBody body, DeviceAPIHeader header)
        {
            Body = body;
            Header = header;
        }
