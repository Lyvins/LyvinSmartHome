...
//                                                                      //
//----------------------------------------------------------------------//
//  File            :   DeviceZoneListRequestBody.cs                                //
//  Description     :                                                   //
...
{
    [DataContract]
    public class DeviceZoneListRequestBody
    {
        [DataMember]
		...
		public DeviceZoneListRequestBody()
        {
            DeviceAPIApplication = new DeviceAPIApplication();
		}

        public DeviceZoneListRequestBody(DeviceAPIApplication deviceAPIApplication, string emID, int importance)
        {
