...
//                                                                      //
//----------------------------------------------------------------------//
//  File            :   DeviceGroupListRequestBody.cs                                //
//  Description     :                                                   //
...
{
    [DataContract]
    public class DeviceGroupListRequestBody
    {
        [DataMember]
		...
		public DeviceGroupListRequestBody()
        {
            DeviceAPIApplication = new DeviceAPIApplication();
		}

        public DeviceGroupListRequestBody(DeviceAPIApplication deviceAPIApplication, string emid, int importance)
        {
