...
namespace LyvinDeviceAPIContracts.DeviceAPIMessages
{
    ...
    {
        [DataMember]
        public DeviceListRequestBody Body { get; set; }
        ...
        {
            Body = new DeviceListRequestBody();
            Header = new DeviceAPIHeader();
		}

        public DeviceListRequest(DeviceListRequestBody body, DeviceAPIHeader header)
        {
            Body = body;
            Header = header;
        }
