...
{
    [DataContract]
    public class DeviceUpdateReplyBody
    {
        ...
        public DeviceUpdateReplyBody()
        {
            Errors = new List<DeviceAPIError>();
            Warnings = new List<DeviceAPIWarning>();
        }

        public DeviceUpdateReplyBody(string emID, List<DeviceAPIError> errors, string status,
