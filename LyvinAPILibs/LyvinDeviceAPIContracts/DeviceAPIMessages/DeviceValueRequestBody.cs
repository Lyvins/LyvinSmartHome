...
//                                                                      //
//----------------------------------------------------------------------//
//  File            :   DeviceValueRequestBody.cs                                //
//  Description     :                                                   //
...
{
    [DataContract]
    public class DeviceValueRequestBody
    {
        [DataMember]
        ...
        public DeviceValueRequestBody(DeviceAPIApplication deviceAPIApplication, DeviceAPIDevice device, List<DeviceAPIAttribute> deviceTypeAttributes, string emID, int importance)
        {
