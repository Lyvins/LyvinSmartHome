...
//                                                                      //
//----------------------------------------------------------------------//
//  File            :   DeviceZoneListReplyBody.cs                                //
//  Description     :                                                   //
...
{
    [DataContract]
    public class DeviceZoneListReplyBody
    {
        [DataMember]
		...
		public DeviceZoneListReplyBody()
        {
            DeviceAPIApplication = new DeviceAPIApplication();
            DeviceZones = new List<DeviceAPIDeviceZone>();
		}

        public DeviceZoneListReplyBody(DeviceAPIApplication deviceAPIApplication, List<DeviceAPIDeviceZone> deviceZones, string emID, int importance)
        {
