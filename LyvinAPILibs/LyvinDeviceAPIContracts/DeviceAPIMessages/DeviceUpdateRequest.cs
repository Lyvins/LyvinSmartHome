...
namespace LyvinDeviceAPIContracts.DeviceAPIMessages
{
    ...
    public class DeviceUpdateRequest
    {
        ...
        [DataMember]
        public DeviceUpdateRequestBody Body { get; set; }
        ...
        {
            Body = new DeviceUpdateRequestBody();
            Header = new DeviceAPIHeader();
        }

        public DeviceUpdateRequest(DeviceUpdateRequestBody body, DeviceAPIHeader header)
        {
            Body = body;
            Header = header;
        }
