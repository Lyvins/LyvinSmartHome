...
//                                                                      //
//----------------------------------------------------------------------//
//  File            :   DeviceTypeListRequestBody.cs                                //
//  Description     :                                                   //
...
{
    [DataContract]
    public class DeviceTypeListRequestBody
    {
        [DataMember]
		...
		public DeviceTypeListRequestBody()
        {
            DeviceAPIApplication = new DeviceAPIApplication();
		}

        public DeviceTypeListRequestBody(DeviceAPIApplication deviceAPIApplication, string emID, int importance)
        {
