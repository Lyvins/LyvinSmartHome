...
//                                                                      //
//----------------------------------------------------------------------//
//  File            :   DeviceTypeListReplyBody.cs                                //
//  Description     :                                                   //
...
{
    [DataContract]
    public class DeviceTypeListReplyBody
    {
        [DataMember]
		...
		public DeviceTypeListReplyBody()
        {
            DeviceAPIApplication = new DeviceAPIApplication();
            DeviceTypes = new List<DeviceAPIDeviceType>();
		}

        public DeviceTypeListReplyBody(DeviceAPIApplication deviceAPIApplication, List<DeviceAPIDeviceType> deviceTypes, string emID, int importance)
        {
