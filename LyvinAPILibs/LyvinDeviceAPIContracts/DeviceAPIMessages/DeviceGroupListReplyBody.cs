...
//                                                                      //
//----------------------------------------------------------------------//
//  File            :   DeviceGroupListReplyBody.cs                                //
//  Description     :                                                   //
...
{
    [DataContract]
    public class DeviceGroupListReplyBody
    {
        [DataMember]
		...
		public DeviceGroupListReplyBody()
        {
            DeviceAPIApplication = new DeviceAPIApplication();
            DeviceGroups = new List<DeviceAPIDeviceGroup>();
		}

        public DeviceGroupListReplyBody(DeviceAPIApplication deviceAPIApplication, List<DeviceAPIDeviceGroup> devicegroups, string emid, int importance)
        {
