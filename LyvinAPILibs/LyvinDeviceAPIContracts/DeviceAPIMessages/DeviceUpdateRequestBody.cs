...
//                                                                      //
//----------------------------------------------------------------------//
//  File            :   DeviceUpdateRequestBody.cs                                //
//  Description     :                                                   //
...
namespace LyvinDeviceAPIContracts.DeviceAPIMessages
{
    ...
    public class DeviceUpdateRequestBody
    {
        ...
        public DeviceUpdateRequestBody()
        {
            DeviceAPIApplication = new DeviceAPIApplication();
            DeviceTypeAttributes = new List<DeviceAPIAttribute>();
        }

        public DeviceUpdateRequestBody(DeviceAPIApplication deviceAPIApplication,
                                       List<DeviceAPIAttribute> deviceTypeAttributes, string emID, int importance)
        {
