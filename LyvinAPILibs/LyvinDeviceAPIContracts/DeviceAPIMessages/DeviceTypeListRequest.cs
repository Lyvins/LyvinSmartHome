...
namespace LyvinDeviceAPIContracts.DeviceAPIMessages
{
    ...
    {
        [DataMember]
        public DeviceTypeListRequestBody Body { get; set; }
        ...
        {
            Body = new DeviceTypeListRequestBody();
            Header = new DeviceAPIHeader();
		}

        public DeviceTypeListRequest(DeviceTypeListRequestBody body, DeviceAPIHeader header)
        {
            Body = body;
            Header = header;
        }
