...
{
    [DataContract]
    public class DeviceListRequestBody
    {
        [DataMember]
        ...
        public DeviceListRequestBody(DeviceAPIApplication deviceAPIApplication, List<DeviceAPIDeviceGroup> devicegroups, List<DeviceAPIDeviceType> devicetypes, List<DeviceAPIDeviceZone> devicezones, string emid, int importance)
        {
