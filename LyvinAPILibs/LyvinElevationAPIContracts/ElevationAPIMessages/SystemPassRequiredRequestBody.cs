...
//                                                                      //
//----------------------------------------------------------------------//
//  File            :   SystemPassRequiredRequestBody.cs                                //
//  Description     :                                                   //
...
{
    public class SystemPassRequiredRequestBody
    {
        ...
        public ElevationAPIUser User { get; set; }
        ...
        public SystemPassRequiredRequestBody()
        {
