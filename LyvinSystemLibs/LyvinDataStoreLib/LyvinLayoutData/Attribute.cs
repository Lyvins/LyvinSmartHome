...
//----------------------------------------------------------------------//
//  File            :   Attribute.cs                                    //
//  Description     :   Stores all attribute data and functions as a    //
...
{
    /// <summary>
    /// Stores all attribute data and functions as a serializable object for the database and xml
    /// </summary>
    [TableName("attribute")]
    ...
    public class Attribute
    {
        ...
        public Attribute(string name, string status)
        {
            Name = name;
            Status = status;
        }
